...
foreach ($dir in '.claude', '.agents') {
  ...
  Set-Content -Path (Join-Path $skillsPath '.forge-generated') -Value 'generated by forge-ai sync — do not edit; edit the forge-ai source instead'
}
...
Write-Host "forge-ai sync: generated AGENTS.md, opencode.json, .claude/ (settings + skills), .agents/skills, and .codex/config.toml into $OutRoot"
